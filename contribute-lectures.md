...
The QuantEcon Lectures has three different series each have their own repository
- [Python Programming for Economics and Finance](https://github.com/QuantEcon/lecture-python-programming)
- [Quantitative Economics with Python](https://github.com/QuantEcon/lecture-python-intro)
...
These are here to maintain consistency across the letures.
